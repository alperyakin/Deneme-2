...
using Deneme2.Services.CategoryService.Application.Categories.v1.Commands.Delete;

namespace Deneme2.Services.CategoryService.WebApi.Endpoints.Categories.v1.Delete;
